...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'usuarios_tipousuario', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('usuario', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True)),
            ('asignacion', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['usuarios.Rol'])),
        ))
        db.send_create_signal(u'usuarios', ['TipoUsuario'])

        # Adding model 'Rol'
        db.create_table(u'usuarios_rol', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'usuarios', ['Rol'])


    def backwards(self, orm):
        # Deleting model 'TipoUsuario'
        db.delete_table(u'usuarios_tipousuario')

        # Deleting model 'Rol'
        db.delete_table(u'usuarios_rol')
    ...
    models = {
        ...
        u'usuarios.tipousuario': {
            'Meta': {'object_name': 'TipoUsuario'},
            'asignacion': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['usuarios.Rol']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
